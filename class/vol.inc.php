...
class flight_class extends objet_core
{
	...
	(
		...
		"callsign" => Array("type" => "varchar","len"=>8, "index"=>"1","placeholder"=>"F-BTXX"),
		"type" => Array("type" => "varchar","len"=>4,"Default"=>"P","placeholder"=>"P"),
		"field_from" => Array("type" => "varchar","len"=>4, "index"=>"1","placeholder"=>"LFGC"),
		"field_to" => Array("type" => "varchar","len"=>4, "index"=>"1","placeholder"=>"LFGC"),
		...
		"nb_ifr" => Array("type" => "number","placeholder"=>"0"),
		"nb_att" => Array("type" => "number","default"=>1),
		"nb_amerr" => Array("type" => "number","placeholder"=>"0"),
	);
